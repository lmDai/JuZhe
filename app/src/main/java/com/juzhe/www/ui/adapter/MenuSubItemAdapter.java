 ...
 * @description: 介绍
 **/
public class MenuSubItemAdapter extends BaseQuickAdapter<CutomHomeModel.DataBean.MenuBean.SubItemBean, BaseViewHolder> {
    public MenuSubItemAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, CutomHomeModel.DataBean.MenuBean.SubItemBean item) {
